...
import com.github.viviel.socketio.broadcast.operations.SimpleBroadcastOperationsFactory;
import com.github.viviel.socketio.handler.SuccessAuthorizationListener;
import com.github.viviel.socketio.listener.DefaultExceptionListener;
import com.github.viviel.socketio.listener.ExceptionListener;
import com.github.viviel.socketio.protocol.JsonSupport;
import com.github.viviel.socketio.store.HazelcastStoreFactory;
import com.github.viviel.socketio.store.MemoryStoreFactory;
import com.github.viviel.socketio.store.RedissonStoreFactory;
...
public class Configuration {
    ...
    private BroadcastOperationsFactory broadcastOperationsFactory = new SimpleBroadcastOperationsFactory();
    ...
    Configuration(Configuration conf) {
        ...
        if (conf.getJsonSupport() == null) {
            try {
                ...
                try {
                    Class<?> jjs = getClass().getClassLoader().loadClass("com.github.viviel.socketio.protocol.JacksonJsonSupport");
        ...
        setBroadcastOperationsFactory(conf.getBroadcastOperationsFactory());
    ...
    public BroadcastOperationsFactory getBroadcastOperationsFactory() {
        return broadcastOperationsFactory;
    }

    public void setBroadcastOperationsFactory(BroadcastOperationsFactory broadcastOperationsFactory) {
        this.broadcastOperationsFactory = broadcastOperationsFactory;
    }
